        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    System.out.println("■■■■■■■■■■■■■■■　当たり付き　ITEカフェシステム　レジ画面（商品一覧） ■■■■■■■■■■■■■■■■■■■■■");
                    ...
                    if(0>=inputItemNum){
                    System.out.println("【※0以下の数字は入力できません！！！】");
                          continue;
                    }
                    ...
                    if(0>=inputItemCount){
                      System.out.println("【※0以下の入力は受け付けてません】");
                        continue;
                    }
            ...
            if(Integer.parseInt(azukariKin)<=goukeiKin){
            System.out.println("お金が足りないため、エラーが発生しました。");
            break;
            }
            ...
            kaikeiNo++;
            System.out.println("-------------------------------");
            System.out.println("進む=(任意の文字を入力)");
            String inputChar = sc.next();
            ...
            System.out.println("-------------------------------");
            System.out.println("●●●●●●●●●●●●●●●●●●●●●●●●●");
            System.out.println("●---------------くじ------------------●");
            System.out.println("●ゾロ目　当たり   　　10％還元            ●");
            System.out.println("●それ以外 はずれ  　　何もなし   　  　    ●");
            System.out.println("●●●●●●●●●●●●●●●●●●●●●●●●●");
            System.out.println("-------------------------------");
            System.out.println("進む=(任意の文字を入力)");
            String inputCha = sc.next();
            int L06;
            L06 = (int)(Math.random() * 1000);
                System.out.printf("\b\b\b%03d", L06);
                System.out.println("　くじ番号");
                System.out.println("");
                if (L06 % 111 == 0) {
                System.out.println("当たり！");
                goukeiKin = (int) (Math.floor(goukeiKin * 0.9));
                System.out.println(goukeiKin);
                int turi = Integer.parseInt(azukariKin) - goukeiKin;          
                System.out.println("釣銭が" + turi + "円に増えました！");
                }else{
             System.out.println("はずれ！");
            }
            System.out.println("進む=(任意の文字を入力)");
            String inputCh = sc.next();
            System.out.println("ありがとうございました。最初に戻ります。");
           ...
           System.out.println("※正しく入力されなかったため、エラーが発生しました。");
          }
    }
